...
fun PaddingValues.minus(
    ...
    PaddingValues(
        start =
            (calculateStartPadding(layoutDirection) - other.calculateStartPadding(layoutDirection)).coerceAtLeast(
                0.dp,
            ),
        top = (calculateTopPadding() - other.calculateTopPadding()).coerceAtLeast(0.dp),
        end =
            (calculateEndPadding(layoutDirection) - other.calculateEndPadding(layoutDirection)).coerceAtLeast(
                0.dp,
            ),
...
fun PaddingValues.coerceAtMost(
    ...
    PaddingValues(
        start =
            calculateStartPadding(layoutDirection).coerceAtMost(
        ...
        top = calculateTopPadding().coerceAtMost(paddingValues.calculateTopPadding()),
            ...
            calculateEndPadding(layoutDirection).coerceAtMost(
